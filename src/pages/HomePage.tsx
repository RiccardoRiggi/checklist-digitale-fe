...
export default function HomePage() {
    ...
    const ricerca = async () => {
        ...
        await templateService.listaTemplates(sessionStorage.getItem("token")).then(response => {
            setNumeroChecklistTemplate(response.data.length);
        }).catch(e => {
            console.error(e);
        });

        await checklistService.listaChecklist(sessionStorage.getItem("token")).then(response => {
            setNumeroChecklist(response.data.length);
        }).catch(e => {
            console.error(e);
        });
